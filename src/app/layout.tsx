...
export const metadata: Metadata = {
  title: "Happy IT-shnik - Launch Your IT Career | Programming Bootcamp",
  description: "Transform your career with Happy IT-shnik's comprehensive IT education programs. Learn programming, web development, and data science with expert instructors and guaranteed job placement support.",
  keywords: "IT bootcamp, programming school, web development course, data science training, career change, coding bootcamp, software development education",
  metadataBase: new URL("https://happy-it-shnik.com"),
  alternates: {
    canonical: "https://happy-it-shnik.com"
  },
  openGraph: {
    title: "Happy IT-shnik - Launch Your IT Career",
    ...
    url: "https://happy-it-shnik.com",
    siteName: "Happy IT-shnik",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Happy IT-shnik - Launch Your IT Career",
    description: "Transform your career with comprehensive IT education programs and expert mentorship.",
